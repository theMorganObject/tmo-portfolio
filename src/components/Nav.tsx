  ...
  return (
    <div className='fixed top-0 right-0 m-8 z-50'>
      <div className='grid grid-cols-2 grid-rows-2 gap-1'>
        ...
        <Link href='/'>
          ...
          >
            <svg
              ...
              viewBox='0 0 256 256'
              className={`${
                pathname === '/' ? 'fill-gray-1' : 'fill-gray-5'
              } group-hover:fill-gray-0`}
            >
        ...
        <Link href='/about'>
          <div
            className={`group flex justify-center items-center transform -skew-x-6 ${
              pathname === '/about' ? 'bg-red-4/70' : 'bg-red-4/20'
            } hover:bg-red-4/70 h-8 w-8 xs:h-8 xs:w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-14 lg:w-14`}
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width={svgSize.width}
              ...
              viewBox='0 0 256 256'
              className={`${
                pathname === '/about' ? 'fill-red-1' : 'fill-red-4'
              } group-hover:fill-red-0`}
            >
        ...
        <Link href='/contact'>
          <div
            ...
            } hover:bg-lime-7/70 h-8 w-8 xs:h-8 xs:w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-14 lg:w-14`}
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width={svgSize.width}
              ...
              viewBox='0 0 256 256'
              className={`${
                pathname === '/contact' ? 'fill-lime-2' : 'fill-lime-6'
              } group-hover:fill-lime-0`}
            >
