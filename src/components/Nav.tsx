  ...
  return (
    <div className='fixed top-0 right-0 m-8 z-50'>
      <div className='grid grid-cols-2 grid-rows-2 gap-1'>
        ...
        <Link href='/'>
          <div
            className={`group flex justify-center items-center bg-gray-6/20 transform -skew-x-6 hover:bg-gray-6/70 ${
              pathname === '/' ? 'bg-gray-6/70' : ''
          ...
          >
            <svg
              ...
              viewBox='0 0 256 256'
              className={`fill-gray-5 group-hover:fill-gray-0 ${
                pathname === '/' ? 'fill-gray-0' : ''
              }`}
            >
        ...
        <Link href='/projects'>
          <div
            className={`group flex justify-center items-center bg-blue-3/20 transform -skew-x-6 hover:bg-blue-3/70 ${
              pathname === '/projects' ? 'bg-blue-3/70' : ''
            } h-8 w-8 xs:h-8 xs:w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-14 lg:w-14`}
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width={svgSize.width}
              height={svgSize.height}
              className={`fill-blue-3 group-hover:fill-gray-0 ${
                pathname === '/projects' ? 'fill-gray-0' : ''
              }`}
              viewBox='0 0 256 256'
            >
        ...
        <Link href='/about'>
          <div
            className={`group flex justify-center items-center bg-red-4/20 transform -skew-x-6 hover:bg-red-4/70 ${
              pathname === '/about' ? 'bg-red-4/70' : ''
            } h-8 w-8 xs:h-8 xs:w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-14 lg:w-14`}
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width={svgSize.width}
              height={svgSize.height}
              className={`fill-red-4 group-hover:fill-red-0 ${
                pathname === '/about' ? 'fill-red-0' : ''
              }`}
              viewBox='0 0 256 256'
            >
        ...
        <Link href='/contact'>
          <div
            className={`group flex justify-center items-center bg-lime-7/20 transform -skew-x-6 hover:bg-lime-7/70 ${
              pathname === '/contact' ? 'bg-lime-7/70' : ''
            } h-8 w-8 xs:h-8 xs:w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-14 lg:w-14`}
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width={svgSize.width}
              height={svgSize.height}
              className={`fill-lime-6 group-hover:fill-lime-0 lg:h-42 lg:w-42 ${
                pathname === '/contact' ? 'fill-lime-0' : ''
              }`}
              viewBox='0 0 256 256'
            >
