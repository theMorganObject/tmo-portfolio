...
export default function Home() {
  ...
  return (
    <section className='min-h-screen bg-gray-9 flex flex-col items-center p-4'>
      ...
      <h1 className='text-base text-lime-6 leading-loose mb-8 xs:text-xl xs:mb-10 sm:text-4xl md:text-5xl md:mb-14 lg:text-6xl'>
